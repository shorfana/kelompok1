...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <title>Cloud Perpus Register </title>
            ...
            <div class="row m-0">
                ...
                <div class="col-lg-6 col-12 p-0">
                    <div class="card rounded-0 mb-0 px-2">
                        ...
                        <p class="px-2">Selamat Datang Di Register trial</p>
                        <div class="card-content">
                            <div class="card-body pt-1">
                                <form action="<?php base_url() ?>login/login_act" method="POST">

                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                        <input type="text" class="form-control" id="user-name" name="namaper" placeholder="Nama Perupustakaan" required>
                                        <div class="form-control-position">
                                            <i class="feather icon-user"></i>
                                        </div>
                                        <label for="user-name">Alamat Perusahaan</label>
                                    </fieldset>
                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                        <input type="text" class="form-control" id="user-name" name="alamat" placeholder="Alamat Perpustakaan" required>
                                        <div class="form-control-position">
                                            <i class="feather icon-user"></i>
                                        </div>
                                    ...
                                    <fieldset class="form-label-group form-group position-relative has-icon-left">
                                        ...
                                        <label for="user-name">Nama Perupustakaan</label>
                                    </fieldset>
                                    ...
                                    <!-- <fieldset class="form-label-group form-group position-relative has-icon-left">
                                        ...
                                        <label for="user-name">Gambar</label>
                                    </fieldset> -->
                                    <div class="form-group d-flex justify-content-between align-items-center">
                                        ...
                                        <!-- <div class="text-right"><a href="<?php base_url() ?>login/lupapass" class="card-link">Forgot Password?</a></div> -->
                                    </div>
